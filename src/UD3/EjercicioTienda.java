	...
	¿Qué quieres hacer?
	    */
	        ...
	        public static void main(String[] args) {
	                ...
	                productos[0] = "Nada";
	                productos[1] = "Casa de Bernarda Alba";
	                productos[2] = "La Celestina";
	                ...
	                while (continuar)
	                {
	                        ...
	                        switch (opcion)
	                        {
	                                ...
	                                case 7:
	                                        ...
	                                        break;
	                                case 8: 
	                                	ordenarmenormayor(teclado,productos,precios);
	                                	break;
	                                case 9:
	                                	ordenarmayormenor(teclado,productos,precios);
	                                	break;
	                        }
	                }// fin del while
	                teclado.close();
	        ...
	        public static void ordenarmenormayor (Scanner teclado,String[] productos, float[] precios) {
	        	float aux;
	        	String aux2;
	        ...
	        public static void ordenarmayormenor (Scanner teclado,String[] productos, float[] precios) {
	        	float aux;
	        	String aux2;
	        	for(int i = 0;i<precios.length;i++)
				{
